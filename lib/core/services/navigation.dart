...
class Navigation {
  ...
  Future<dynamic>? toRemoveUntil(String routeName, {dynamic arguments}) {
    return navigatorKey.currentState?.pushNamedAndRemoveUntil(
      routeName,
      //Note: remove all routs until "routeName"
      (Route<dynamic> route) => false,
      arguments: arguments,
    );
  }

  Future<dynamic>? toRemoveUntilHome(String routeName, {dynamic arguments}) {
    return navigatorKey.currentState?.pushNamedAndRemoveUntil(
      routeName,
      //Note: remove all routs until "routeName" and keep rout to "home page"
