...
class AccessAlertDetails extends StatefulWidget {
  const AccessAlertDetails({
    Key? key,
    required this.model,
    required this.image,
  }) : super(key: key);
  ...
  @override
  AccessAlertDetailsState createState() => AccessAlertDetailsState();
}

class AccessAlertDetailsState extends State<AccessAlertDetails> {
  late String _image;
            ...
            body: Column(
              ...
              children: <Widget>[
                ...
                SolidButton(
                  ...
                  onTap: () => context.read<AccessAlertsBloc>().add(HandleAlert(
